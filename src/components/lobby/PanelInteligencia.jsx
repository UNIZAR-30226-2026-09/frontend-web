...
const PanelInteligencia = ({ onCerrar }) => {
  ...
  return (
    <div className="intel-overlay">
      ...
      {confirmandoLogout && (
        <div style={{
          ...
          <div style={{
            ...
            padding: '2rem', borderRadius: '12px', textAlign: 'center', maxWidth: '400px', width: '90%',
            boxShadow: '0 10px 30px rgba(0,0,0,0.8)'
          }}>
            <h3 style={{ color: 'var(--color-state-danger)', marginTop: 0, marginBottom: '1rem', fontSize: '1.5rem', textTransform: 'uppercase' }}>¿Abandonar Campo?</h3>
            <p style={{ color: 'var(--color-text-secondary)', marginBottom: '2rem' }}>
              Estás a punto de cerrar la sesión y salir al menú principal. ¿Deseas continuar?
            </p>
      ...
      <div className="intel-panel" style={(seleccionandoAvatar || confirmandoLogout) ? { filter: 'blur(4px)' } : {}}>
